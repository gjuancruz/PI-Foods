...
async function getAPIRecipes(){
    try{
    const apiAxios = await axios.get(`https://api.spoonacular.com/recipes/complexSearch?apiKey=15368d8987044afa8321c5c040ddfebd&addRecipeInformation=true&number=99`)

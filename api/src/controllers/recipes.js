...
async function getAPIRecipes(){
    try{
    const apiAxios = await axios.get(`https://api.spoonacular.com/recipes/complexSearch?apiKey=d1fda60f775546cbb08941dabbcc0d11&addRecipeInformation=true&number=99`)
